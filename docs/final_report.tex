...
\centering
\includegraphics[width=0.74\textwidth]{figures/kaggle_private_top5.png}
\vspace{0.35em}

\includegraphics[width=0.74\textwidth]{figures/kaggle_final_submission.png}
\vspace{0.25em}

\refstepcounter{figure}
\parbox{0.82\textwidth}{\small \textbf{Figure \thefigure:} Kaggle evidence. Top: private Top-5 threshold (fifth place = 0.08883). Bottom: our strict late submission (private = 0.08098; public shown as supplementary).}
\end{minipage}
\vspace{0.8em}
