...
\begin{enumerate}
  ...
  \item \textbf{Implementation assistance, code review, and reproducibility checks.} AI helped with selected implementation details and helped inspect the cross-validation protocol, pseudo-label filtering, second-stage stacking, README, and one-command reproduction script.
