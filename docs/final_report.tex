...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.92\textwidth]{figures/kaggle_private_top5.png}
\caption{Kaggle private leaderboard Top-5 threshold. The fifth-place private score is 0.08883.}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.86\textwidth]{figures/kaggle_final_submission.png}
\caption{Kaggle late-submission record of our final strict model. We use the private score 0.08098 as the main official result; the public score is displayed by Kaggle only as a supplementary split score.}
\end{figure}
