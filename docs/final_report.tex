...
\begin{figure}[H]
\centering
\includegraphics[width=0.84\textwidth]{figures/kaggle_private_top5.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.78\textwidth]{figures/kaggle_final_submission.png}
\caption{Kaggle late-submission record: final private score 0.08098. The public score is shown only as a supplementary split score.}
\end{figure}
