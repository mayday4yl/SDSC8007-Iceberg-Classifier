...
\centering
\includegraphics[width=0.82\textwidth]{figures/kaggle_private_top5.png}
\vspace{0.7em}

\includegraphics[width=0.82\textwidth]{figures/kaggle_final_submission.png}
\vspace{0.45em}

\refstepcounter{figure}
\parbox{0.88\textwidth}{\small \textbf{Figure \thefigure:} Kaggle evidence for the final result. Top: private leaderboard Top-5 threshold, where the fifth-place private score is 0.08883. Bottom: our final strict late-submission record, with private score 0.08098. The public score is shown only as a supplementary Kaggle split score.}
\end{minipage}
\vspace{1.2em}
